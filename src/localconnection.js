...
(function (LC) {
    ...
    var timestamp = 0,
        ...
        _isConnected = function () {
            ...
            for (var e = 0; e < LC.frames.length; e++) {
                ...
                var statusLog=status?{color:'green',text:' successfully connected '}:{color:'orange',text:' can not connected'};
                console.log('%c-->'+LC.name+'['+LC.key+']'+statusLog.text + ' to  >>> '+ LC.frames[e]+'  ','background:'+statusLog.color+';color:#fff;');
            }
            return status;
        },
        /**
    ...
    LC.onConnect = LC.onConnect || function () {
            console.log('%c \u2611 Default onConnect. Successfully connected','background:#fff;color:green;font-size:16px;');
        };
    ...
    LC.onTimeout = LC.onTimeout || function () {
            console.log('%c \u2612 Default onTimeout. ['+LC.key+'] Could not connected. Quit trying','background:#fff;color:red;font-size:16px;');
        };
